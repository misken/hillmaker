...
copyright = '2022'
exclude_patterns = ['**.ipynb_checkpoints', '.DS_Store', 'Thumbs.db', '_build', 'basic_usage_shortstay_unit_04*.ipynb', 'devnotes/*', 'hillmaker_oo_050.ipynb', 'markdown-notebooks.md', 'markdown.md', 'mynewbook/*', 'notebooks.ipynb']
